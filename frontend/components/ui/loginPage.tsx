...
export default async function LoginPage() {
  const handleGoogleLogin = handleGoogleSignin.bind(null, "login")
  const handleGithubLogin = handleGithubSignin.bind(null, "login")
  return (
      ...
      <div className="border col-span-2 bg-[#191919] h-screen flex flex-col items-center justify-center">
        <div className="space-y-4">
          ...
          <div className="flex space-x-2">
            <Button className="grow" onClick={handleGoogleLogin}>
